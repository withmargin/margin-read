...
export const en = {
  ...
  displayPreviewOriginal: "The original stays close, so reading never turns into guesswork.",
  displayPreviewTranslation: "The translation sits quietly beside it, but stays easy to recognize.",
  displayQuiet: "Quiet",
