...
export const ui = {
  en: {
    ...
    "hero.signup_done": "On the list ✓",
    "hero.signup_placeholder_done": "Will notify you when ready",
  ...
  "zh-Hant": {
    ...
    "hero.cta": "送出",
    "hero.note":
      "無垃圾信、無第三方追蹤。兩個 CTA 同等重要：今天就試，或等上架。",
    "hero.signup_done": "已加入名單 ✓",
    "hero.signup_placeholder_done": "上架時通知你",
